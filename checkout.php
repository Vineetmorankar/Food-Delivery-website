...
if(isset($_POST['submit'])){
   ...
   try {
      ...
      $mail->SMTPAuth = true;
      $mail->Username = 'vineetmorankar393@gmail.com';
      $mail->Password = 'dops yeeg muap fizn';
      $mail->SMTPSecure = 'tls';
      $mail->Port = 587;

      //Recipients
      $mail->setFrom('vineetmorankar393@gmail.com', 'vineet');
      $mail->addAddress($email, $name); // Assuming $email and $name are the user's email and name

      //Content
      $mail->isHTML(true);
      $mail->Subject = 'Order Confirmation';

      // Custom CSS for the email body
      $customCSS = '
         <style>
            body {
      ...
      // Booking information in the email body
      $emailBody = '
         <html>
         <head>' . $customCSS . '</head>
         <body>
      ...
      $mail->send();
      $message[] = 'Order placed successfully! An email has been sent to confirm.';
   } catch (Exception $e) {
      $message[] = 'Order placed successfully! Failed to send email notification.'. $mail->ErrorInfo;
   }
   //mailer end--------------------------------------------------------------------------------------
      }
